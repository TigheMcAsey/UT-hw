...
\begin{document}
    ...
    \begin{pb}
        ...
        Now that we have shown \(\text{Aut}(\rho^{-1}(b_0)) \cong N_G(H)\), it is straightforward to see that the group of deck transformations \(\text{Aut}(X) \cong N_G(H)\). To do so we apply the equivalence of categories of right \(\pi_1(B,b_0)\)-sets and covering spaces \(E \to G\). \textcolor{red}{TODO!!!!!!}
    \end{pb}
    \begin{pb}
