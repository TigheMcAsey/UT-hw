...
\begin{document}
    \begin{pb}
        ...
        Going first right then down we get \(f_*g_*(1)\), going first down we get \(\alpha(f_*[g]) = \alpha([fg]) = (fg)_*(1)\) so naturality follows by functoriality of \(H_1\). \(\alpha\) being well defined follows from homotopic maps inducing the same map of homology, as proven in Monday's lecture.
