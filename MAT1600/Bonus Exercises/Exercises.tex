...
\begin{document}
    ...
    \begin{pb}\textbf{(Durrett 3.7.4)}
        ...
        \end{align*}
        So to show that \(\lim_{t\to\infty}N_1(t)\) is poisson distributed with mean \(\lambda\mu\), it suffices to show that the distribution functions converge pointwise to Poisson \(\lambda\mu\).
    \end{pb}
