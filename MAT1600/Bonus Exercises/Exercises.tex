...
\begin{document}
    ...
    \begin{pb}\textbf{(Durrett 3.4.13)}
        ...
        \begin{align*}
            \abs{c_{n,k}} = \abs{t}\abs{\frac{1 - \cos(tk/n)}{tk/n}} \leq \min\set{\frac{2n}{\abs{tk}},\frac{k}{2n}\abs{t^2}} \leq \min\set{\frac{2n}{\abs{t}},\frac{1}{2}\abs{t^2}}
        \end{align*}
        ...
        \end{align*}
        Which goes to zero as \(n \to \infty\). It follows that by continuity of exponential, we get
    \end{pb}
\end{document}